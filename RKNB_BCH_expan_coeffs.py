...
C1 = BCH6(Y1, X1).simplified()
D1 = BCH6(C1, Y2).simplified()
C2 = BCH6(D1, X2).simplified()
D2 = BCH6(C2, Y3).simplified()
C3 = BCH6(D2, X3).simplified()
D3 = BCH6(C3, Y4).simplified()
C4 = BCH6(D3, X4).simplified()
D4 = BCH6(C4, Y5).simplified()
C5 = BCH6(D4, X5).simplified()
D5 = BCH6(C5, Y6).simplified()

myfile = open('D5_RKNB.dat', 'w')
for D5d in D5.d:
    print >> myfile, D5d
myfile.close()

# creating MAPLE input
myfile = open('RKN_methodB_coeffs.mw', 'w')
